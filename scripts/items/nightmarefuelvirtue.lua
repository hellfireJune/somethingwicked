...
this.HeadSprites = {
    ...
    [SomethingWicked.NightmareSubTypes.NIGHTMARE_HOLY] = {
        "nightmare_sheet_05",
    }
}
...
function this:FamiliarUpdate(familiar)
    ...
    if familiar.FireCooldown <= 0 then
        ...
        if familiar.Target and familiar.Target.Position:Distance(familiar.Position) < this.Distance then
            ...
            local doVirtueFire = familiar.SubType == SomethingWicked.NightmareSubTypes.NIGHTMARE_HOLY
