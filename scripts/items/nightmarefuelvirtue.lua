...
function this:CacheFlag(player)    
    ...
    player:CheckFamiliar(FamiliarVariant.SOMETHINGWICKED_NIGHTMARE, player:GetTrinketMultiplier(TrinketType.SOMETHINGWICKED_VIRTUE), v_rng, v_sourceItem, SomethingWicked.NightmareSubTypes.NIGHTMARE_PERMANENT)
end
